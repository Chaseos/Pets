...
class OldHomeScreenViewModel : ViewModel() {
    ...
    private val pets: LiveData<PagedList<OldPetListItemViewState.Pet>>
    ...
    fun pets(): LiveData<PagedList<OldPetListItemViewState.Pet>> = pets
